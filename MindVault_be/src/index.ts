...
app.delete("/api/v1/content", userMiddleware, async (req, res) => {
  ...
  await contentModel.deleteOne({
    // need to delete both as _id se wo specially card delete ho jayega and userId se kaun user usko bnaya tha(creator) ye pta chlega taki agar koi aur user nhi dekh paye if creator has deleted it
    _id: contentId,
    // @ts-ignore
    userId: req.userId,
  });
